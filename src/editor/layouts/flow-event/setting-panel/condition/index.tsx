...
const ConditionSettingPanel = ({ graphRef, curModel, setSettingOpen }: any, ref: any) => {
    ...
    const nameChange = (value: any, index: number) => {
        setData((prev: any) => {
    ...
    const conditionChange = (value: any, index: number) => {
        setData((prev: any) => {
                        ...
                        return (
                            <Space key={item.id}>
                                ...
                                <SettingOutlined
                                    ...
                                    style={{ color: item.children && 'blue' }}
                                />
                            </Space>
                        )
                    })}
